...
/**
 * InvalidationBasedGorceryManualCacheRegion - Invalidation based abstract implement
 * of GroceryManualCacheRegion
 *
 * This internally uses the Hybris invalidation framework to invalidate cache
 * across cluster nodes
 *
 * @see {@link InvalidationManager}, @see {@link InvalidationTopic} and @see
 *      {@link InvalidationListener}
 *
 *
 */
public abstract class InvalidationBasedGorceryManualCacheRegion implements GroceryManualCacheRegion , InvalidationListener
{

	private static final Logger LOG = Logger.getLogger(InvalidationBasedGorceryManualCacheRegion.class);
   ...
   /**
    * Time to live seconds, default value is null i.e. cache element will live
    * forever
    */
    ...
    * @param cacheName
    */
   public InvalidationBasedGorceryManualCacheRegion(final String cacheName) {
    ...
    *
    * @see
    * de.hybris.platform.cache.InvalidationListener#keyInvalidated(java.lang.
    * Object[], int, de.hybris.platform.cache.InvalidationTarget,
    * de.hybris.platform.cache.RemoteInvalidationSource)
    */
   @Override
