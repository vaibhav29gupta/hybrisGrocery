...
public class GroceryPickupStrategy extends PickupStrategy
{
	private static final Logger LOGGER = LoggerFactory.getLogger(GroceryPickupStrategy.class);
	...
	protected boolean canSourceOrderEntry(AbstractOrderEntryModel entry, SourcingLocation location)
	{
		...
		final boolean isPickupDeliveryMode = warehouseSupportedDeliveryModes.stream()
				.anyMatch(deliveryMode -> deliveryMode instanceof PickUpDeliveryModeModel || "pickup".equals(deliveryMode.getCode()));
