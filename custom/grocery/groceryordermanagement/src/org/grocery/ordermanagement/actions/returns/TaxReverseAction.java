...
package org.grocery.ordermanagement.actions.returns;
...
public class TaxReverseAction extends AbstractSimpleDecisionAction<ReturnProcessModel>
{
	...
	public static final String TAX_REVERSE_FORCE_FAILURE = "groceryordermanagement.reverse.tax.force.failure";
