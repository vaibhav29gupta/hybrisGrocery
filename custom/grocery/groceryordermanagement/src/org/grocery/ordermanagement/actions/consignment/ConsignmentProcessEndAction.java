 ...
 *
 */
package org.grocery.ordermanagement.actions.consignment;
...
public class ConsignmentProcessEndAction extends AbstractProceduralAction<ConsignmentProcessModel>
{
	...
	public void executeAction(final ConsignmentProcessModel process)
	{
		...
		final String eventId =
				process.getParentProcess().getCode() + "_" + GroceryordermanagementConstants.ORDER_ACTION_EVENT_NAME;
		...
		LOG.debug("Process: {} fired event {}", process.getCode(), GroceryordermanagementConstants.ORDER_ACTION_EVENT_NAME);
	}
}
