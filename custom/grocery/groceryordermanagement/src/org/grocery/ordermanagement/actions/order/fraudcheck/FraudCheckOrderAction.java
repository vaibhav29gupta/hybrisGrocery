 ...
 *
 */
package org.grocery.ordermanagement.actions.order.fraudcheck;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	{
		final String value = Config.getParameter(GroceryordermanagementConstants.EXTENSIONNAME + ".fraud." + property);
