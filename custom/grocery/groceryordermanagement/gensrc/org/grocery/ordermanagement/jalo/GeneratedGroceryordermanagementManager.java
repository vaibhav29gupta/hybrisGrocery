...
/**
 * Generated class for type <code>GroceryordermanagementManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedGroceryordermanagementManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, GroceryordermanagementConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, GroceryordermanagementConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return GroceryordermanagementConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, GroceryordermanagementConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, GroceryordermanagementConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, GroceryordermanagementConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, GroceryordermanagementConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
