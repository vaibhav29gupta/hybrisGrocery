 ...
 *
 */
package org.grocery.ordermanagement.actions.order.payment;
...
import org.grocery.ordermanagement.actions.order.payment.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationActionTest
{
	...
	/**
	 * Test method for
	 * {@link org.grocery.ordermanagement.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
