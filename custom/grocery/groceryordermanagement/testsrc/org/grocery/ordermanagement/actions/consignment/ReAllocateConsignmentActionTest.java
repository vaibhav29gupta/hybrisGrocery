...
public class ReAllocateConsignmentActionTest
{
	...
	public void setup()
	{
		...
		when(orderBusinessProcessService
				.createProcess(anyString(), eq(GroceryordermanagementConstants.CONSIGNMENT_SUBPROCESS_NAME)))
		...
		doNothing().when(orderBusinessProcessService)
				.triggerChoiceEvent(orderModel, GroceryordermanagementConstants.ORDER_ACTION_EVENT_NAME,
