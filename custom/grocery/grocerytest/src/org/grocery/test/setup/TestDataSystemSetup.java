 ...
 */
package org.grocery.test.setup;
...
import org.grocery.test.constants.GroceryTestConstants;
import org.grocery.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GroceryTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/grocerytest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/grocerytest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/grocerytest/import/cstickets.impex");
			...
			importImpexFile(context, "/grocerytest/import/csquotes.impex");
		}
	}
}
