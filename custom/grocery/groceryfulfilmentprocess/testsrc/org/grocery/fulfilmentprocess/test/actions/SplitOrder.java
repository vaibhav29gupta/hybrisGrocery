 ...
 */
package org.grocery.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(GroceryFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GroceryFulfilmentProcessConstants.PARENT_PROCESS);
