 ...
 */
package org.grocery.fulfilmentprocess.test.jobs;
...
import org.grocery.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = GroceryFulfilmentProcessConstants.ORDER_PROCESS_NAME;
