...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/grocerystorefront/electronics/en",
						"https://electronics.local:9002/grocerystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/grocerystorefront/electronics/en",
						"https://electronics.local:9002/grocerystorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/grocerystorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/grocerystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/grocerystorefront/electronics/en",
						"https://electronics.local:9002/grocerystorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/grocerystorefront",
						"https://electronics.local:9002/grocerystorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/grocerystorefront",
						"https://electronics.local:9002/grocerystorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/grocerystorefront/electronics/en",
						"https://electronics.local:9002/grocerystorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
