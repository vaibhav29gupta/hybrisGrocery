...
import org.grocery.storefront.controllers.AbstractGrocerySearchPageController.ShowMode;
...
@UnitTest
public class AbstractGrocerySearchPageControllerUnitTest
{
	...
	@InjectMocks
	private final AbstractGrocerySearchPageController controller = new AbstractGrocerySearchPageController()
	{
	...
	//click http://electronics.local:9001/grocerystorefront/Open-Catalogue/Cameras/Digital-Cameras/c/575
	@Test
	public void testPagedDataFlagsCallShowAllOver100ResultsOneDefaultPage()
	{
		...
		BDDMockito.given(Long.valueOf(searchPageData.getPagination().getTotalNumberOfResults()))
				.willReturn(Long.valueOf(AbstractGrocerySearchPageController.MAX_PAGE_LIMIT + 1));
	...
	//click http://electronics.local:9001/grocerystorefront/Open-Catalogue/Cameras/Digital-Cameras/c/575?q=:topRated:category:576
	@Test
	...
	//click http://electronics.local:9001/grocerystorefront/Open-Catalogue/Cameras/Digital-Cameras/c/575?q=:topRated:category:576&show=All
	@Test
	public void testAlldDataFlagsCallShowAllBelow100ResultsOneDefaultPage()
	{
		...
		BDDMockito.given(Long.valueOf(searchPageData.getPagination().getTotalNumberOfResults()))
				.willReturn(Long.valueOf(AbstractGrocerySearchPageController.MAX_PAGE_LIMIT - 1));
		BDDMockito.given(Integer.valueOf(searchPageData.getPagination().getPageSize()))
				.willReturn(Integer.valueOf(AbstractGrocerySearchPageController.MAX_PAGE_LIMIT));
