...
<li class="cart-item">
    ...
    <div class="item__info cart-item-details">
    	...
    	<%-- quantity --%>
	    <div class="item__quantity cart-quantity cart-item-quantity shownone">
	    ...
	    <%-- total --%>
    <div class="item__total cart-item-total-price-mobile shownone">
    ...
    <div class="item__quantity cart-quantity cart-item-quantity cart-item-text-desktop">
     ...
     <%-- total --%>
    <div class="item__total cart-item-total-price">
        <ycommerce:testId code="orderDetails_productTotalPrice_label">
            <format:price priceData="${orderEntry.totalPrice}" displayFreeForZero="true"/>
        </ycommerce:testId>
    </div>
