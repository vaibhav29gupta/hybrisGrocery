        ...
        <c:if test="${hasPreviousPage}">
            <li class="pagination-prev">
                ...
                <ycommerce:testId code="searchResults_previousPage_link">
                    <a href="${previousPageUrl}" rel="prev" class="fa fa-chevron-left"></a>
                </ycommerce:testId>
            </li>
        </c:if>

        <c:if test="${!hasPreviousPage}">
            <li class="pagination-prev disabled"><span class="fa fa-chevron-left"></span></li>
        </c:if>
        ...
        <c:if test="${hasNextPage}">
            <li class="pagination-next">
                ...
                <ycommerce:testId code="searchResults_nextPage_link">
                    <a href="${nextPageUrl}" rel="next" class="fa fa-chevron-right"></a>
                </ycommerce:testId>
            </li>
        </c:if>

        <c:if test="${!hasNextPage}">
            <li class="pagination-next disabled"><span class="fa fa-chevron-right"></span></li>
        </c:if>
    </ul>
</c:if>