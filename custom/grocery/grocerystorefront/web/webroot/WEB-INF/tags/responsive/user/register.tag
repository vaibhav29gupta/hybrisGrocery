...
<form:form method="post" modelAttribute="registerForm" action="${action}">
    <formElement:formSelectBoxDefaultEnabled idKey="register.title" labelKey="register.title" selectCSSClass="form-control" path="titleCode" mandatory="true" skipBlank="false"
    ...
    <div class="register-shipment-selector preferred-shipment-section ">
        <storepickup:pickupMode shipmentType="${shipmentType }" storeValue="${storeName }" storeID="${storeID }" postalCode="${postalCode }" isCheckoutPage="${false }" />
    </div>
        ...
        <div class="consent">
            ...
            <div class="checkbox">
                <label class="control-label uncased">
                    ...
                    ${consentTemplateData.description}
                </label>
    ...
    <div class="form-actions clearfix preferres-shipment-siblings">
        <ycommerce:testId code="register_Register_button">
            <button type="submit" class="btn btn-primary btn-block preferred-shipment-btn" disabled="disabled">
