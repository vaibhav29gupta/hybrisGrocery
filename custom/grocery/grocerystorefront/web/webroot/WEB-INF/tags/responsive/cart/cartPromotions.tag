...
<c:if test="${not empty cartData.potentialOrderPromotions}">
    <div class="potential-promotions">
        ...
        <ycommerce:testId code="potentialPromotions_promotions_labels">
            <c:forEach items="${cartData.potentialOrderPromotions}" var="promotion">
                <div class="promotion"><i class="fa fa-asterisk"></i>${ycommerce:sanitizeHTML(promotion.description)}</div>
            </c:forEach>
        </ycommerce:testId>
    </div>
</c:if>
    ...
    <div class="applied-promotions">
        ...
        <ycommerce:testId code="cart_recievedPromotions_labels">
            <c:forEach items="${cartData.appliedOrderPromotions}" var="promotion">
                <div class="promotion"><i class="fa fa-certificate"></i>${ycommerce:sanitizeHTML(promotion.description)}</div>
            </c:forEach>
        </ycommerce:testId>
    </div>
</c:if>
