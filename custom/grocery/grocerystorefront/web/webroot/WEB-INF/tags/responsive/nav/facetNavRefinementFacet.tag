...
<ycommerce:testId code="facetNav_title_${facetData.name}">
	<div class="facet js-facet">
		...
		<div class="facet-values js-facet-values js-facet-form">
							...
							<c:if test="${facetData.multiSelect}">
								...
								<!-- facetValue.query.query.value and searchPageData.freeTextSearch are html output encoded in the backend -->
									...
									<label>
										...
										<span class="facet-list-label">
											<span class="facet-list-mark"></span>
											<span class="facet-list-text">
			...
			<ul class="facet-list js-facet-list <c:if test="${not empty facetData.topValues}">facet__list--hidden js-facet-list-hidden</c:if>">
