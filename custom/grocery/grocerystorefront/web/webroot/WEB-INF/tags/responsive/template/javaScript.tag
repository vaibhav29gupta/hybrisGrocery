...
<c:choose>
    ...
    <c:otherwise>
        ...
        <%-- <script
			src="${commonResourcePathHtml}/js/jquery.slideviewer.custom.1.2.js"></script> --%>
        <script src="${themeResourcePath}/js/jquery.slideviewer.custom.1.2.js"></script>
        <%-- Custom ACC JS --%>
        <%-- 		<script src="${commonResourcePathHtml}/js/acc.address.js"></script> --%>
        <script src="${themeResourcePath}/js/acc.address.js"></script>
        <%-- <script src="${commonResourcePathHtml}/js/acc.autocomplete.js"></script>  --%>
        <script src="${themeResourcePath}/js/acc.autocomplete.js"></script>
        <%-- 		<script src="${commonResourcePathHtml}/js/acc.carousel.js"></script> --%>
        <script src="${themeResourcePath}/js/acc.carousel.js"></script>
        <script src="${themeResourcePath}/js/acc.login.js"></script>
        <script src="${themeResourcePath}/js/acc.shipmentChange.js"></script>
        <script src="${themeResourcePath}/js/acc.productwishlisttooltipaction.js"></script>
        <%-- <script src="${commonResourcePathHtml}/js/acc.cart.js"></script> --%>
        <script src="${themeResourcePath}/js/acc.cart.js"></script>
        <script src="${commonResourcePathHtml}/js/acc.cartitem.js"></script>
        <%-- <script src="${commonResourcePathHtml}/js/acc.checkout.js"></script> --%>
        <script src="${themeResourcePath}/js/acc.checkout.js"></script>
        <script src="${themeResourcePath}/js/acc.checkoutsteps.js"></script>
        <script src="${commonResourcePathHtml}/js/acc.cms.js"></script>
        <%-- <script src="${commonResourcePathHtml}/js/acc.colorbox.js"></script> --%>
        <script src="${themeResourcePath}/js/acc.colorbox.js"></script>
        ...
        <script src="${themeResourcePath}/js/acc.forgottenpassword.js"></script>
        <script src="${themeResourcePath}/js/acc.global.js"></script>
        ...
        <script src="${themeResourcePath}/js/acc.langcurrencyselector.js"></script>
        <%-- <script src="${commonResourcePathHtml}/js/acc.minicart.js"></script> --%>
        <script src="${themeResourcePath}/js/acc.minicart.js"></script>
        <script src="${themeResourcePath}/js/acc.navigation.js"></script>
       ...
       <script src="${commonResourcePathHtml}/js/acc.pickupinstore.js"></script>
        ...
        <script src="${themeResourcePath}/js/acc.product.js"></script>
        <%-- 		<script src="${commonResourcePathHtml}/js/acc.productDetail.js"></script> --%>
        <script src="${themeResourcePath}/js/acc.productDetail.js"></script>
        <%-- 		<script src="${themeResourcePath}/js/acc.addtocartaction.js"></script> --%>
        ...
        <script src="${themeResourcePath}/js/acc.silentorderpost.js"></script>
        <script src="${themeResourcePath}/js/acc.tabs.js"></script>
        ...
        <script src="${themeResourcePath}/js/acc.storefinder.js"></script>
        ...
        <script src="${themeResourcePath}/js/acc.savedcarts.js"></script>
        ...
        <script src="${themeResourcePath}/js/acc.closeaccount.js"></script>
        <script src="${commonResourcePathHtml}/js/acc.csv-import.js"></script>
        <script src="${themeResourcePath}/js/acc.shipment.js"></script>
        <%-- <script src="${themeResourcePath}/js/acc.shipmentSelection.js"></script> --%>
        <script src="${themeResourcePath}/js/acc.wishlist.js"></script>
        ...
        <%-- stocknotification custom javascript --%>
        <script src="${themeResourcePath}/js/stocknotificationaddon.js"></script>
<%--         <script src="${themeResourcePath}/js/chatbot.js"></script> --%>
    </c:otherwise>
</c:choose>
