...
<template:page pageTitle="${pageTitle}">
	...
	<div class="search-empty">
		<div class="heading">
			<spring:theme code="search.no.results" arguments="${searchPageData.freeTextSearch}" var="noSearchResultsheading" htmlEscape="false"/>
			${ycommerce:sanitizeHTML(noSearchResultsheading)}
		</div>
        <div class="sub-heading">
            <spring:theme code="search.no.results.tagline" var="noSearchResults" htmlEscape="false"/>
