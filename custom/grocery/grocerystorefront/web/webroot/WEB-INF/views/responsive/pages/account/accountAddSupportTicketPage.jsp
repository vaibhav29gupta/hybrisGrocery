        ...
        <div class="account-section-form">
            ...
            <form:form method="post" modelAttribute="supportTicketForm" enctype="multipart/form-data">
                ...
                <c:if test="${not empty associatedObjects}">
                    <div class="form-group">
                        ...
                        <form:select path="associatedTo" cssClass="form-control">
                           ...
                           <c:forEach var="associatedCheck" items="${associatedObjects}">
                           <c:set var="check" value="false" />
                           <c:if test= "${associatedCheck.key eq 'cart'}">
                                    ...
                                    <form:option value="${associatedMap.key}=${associatedItem.code}">
                                        <c:choose>
                                            <c:when test="${'SavedCart' eq associatedItem.type }">
                                                <spring:message code="text.account.supporttickets.createTicket.${associatedItem.type}" />: ${associatedItem.code}; <spring:message
                                                    code="text.account.supporttickets.createTicket.updated" />: <fmt:formatDate pattern="dd/MM/yy"
                                                    value="${associatedItem.modifiedtime}" />
                                            </c:when>
                                            <c:otherwise>
                                                <spring:message code="text.account.supporttickets.createTicket.${associatedMap.key}" />: ${associatedItem.code}; <spring:message
                                                    code="text.account.supporttickets.createTicket.updated" />: <fmt:formatDate pattern="dd/MM/yy"
                                                    value="${associatedItem.modifiedtime}" />
                                            </c:otherwise>
                                        </c:choose>
                ...
                <c:if test="${not empty categories}">
                    <div class="form-group">
                        <label class="control-label" for="text.account.supporttickets.createTicket.ticketCategory">
                 ...
                 <formElement:formInputBox idKey="createTicket-subject" labelKey="text.account.supporttickets.createTicket.subject" path="subject" inputCSS="text"
                    mandatory="true" />
                ...
                <formElement:formTextArea idKey="createTicket-message" labelKey="text.account.supporttickets.createTicket.message" path="message" mandatory="true"
                    areaCSS="form-control" labelCSS="control-label" />
