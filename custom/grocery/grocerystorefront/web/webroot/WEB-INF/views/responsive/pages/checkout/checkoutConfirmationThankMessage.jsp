	...
	<div class="checkout-success">
		...
		<div class="account-pages">
			<div class="main-content">
				...
				<order:orderdetails order="${order}" storeDetails="${storeDetails}" statusDate="${statusDate}" isDeliveryModeSet="${isDeliveryModeSet}" deliverySlotInfo="${orderData.deliverySlotInfo}"/>
	                ...
	                <div class="col-sm-8 col-sm-push-2 col-md-6 col-md-push-3">
	                    ...
	                    <div class="accountActions-bottom">
	                        <ycommerce:testId code="guest_Register_button">
	                            <button type="submit" class="btn btn-block btn-primary guest-checkout-btn" disabled="disabled">
