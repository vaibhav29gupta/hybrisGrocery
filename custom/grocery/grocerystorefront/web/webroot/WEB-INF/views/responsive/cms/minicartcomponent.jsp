...
<div class="mini-cart-component">
	<div class="nav-cart">
		<a
			...
			<div class="mini-cart-icon icon">
				<i class="fa fa-shopping-cart" aria-hidden="true"></i>
				<div class="mini-cart-count js-mini-cart-count">
					<span class="nav-items-total">${totalItems lt 100 ? fn:escapeXml(totalItems) : "99+"}<span
	...
	<div class="mini-cart-container js-mini-cart-container shownone">
		<div class="generic-error generic-error-static">
			<spring:theme code="add.to.cart.error" />
		</div>
