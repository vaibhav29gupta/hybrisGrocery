...
,
"sessionError":{"message":"${errorMsg}"},
"shipmentTypeSet":"${shipmentTypeSet}",
...
<div class="cart_popup_error_msg">
                    ...
                    <c:when test="${errorMsg ne null and not empty errorMsg}">
<div class="cart_popup_error_msg">
            ...
            <ycommerce:testId code="checkoutLinkInPopup">
                <a href="${fn:escapeXml(cartUrl)}" class="btn-primary rounded add-to-cart-button checkout-add-to-cart-button hidden">
	                <c:choose>
		                <c:when test="${isQuote}">
...
"cartLayer":"<spring:escapeBody javaScriptEscape="true" htmlEscape="false">
	<spring:htmlEscape defaultHtmlEscape="true"><cart:cartDetails cartData="${cartData }" emptyCartImageUrl="${emptyCartImage.url  }" /></spring:htmlEscape></spring:escapeBody>"
}
