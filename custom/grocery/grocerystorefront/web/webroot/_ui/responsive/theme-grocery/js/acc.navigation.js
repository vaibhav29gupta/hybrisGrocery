...
ACC.navigation = {
    ...
    myAccountNavigation: function(){
        ...
        var oMainNav = $(".navigation--bottom > ul.main-header-features.nav__links--products");
        ...
        if(oUserInfo && oUserInfo.length === 1)
        {
			...
			.append($("<div>")
					.addClass("userGroup")
					.append($("<span>")
							.addClass("myAcctUserIcon icon").append($("<i>").addClass("fa fa-user")))
							.append($("<div>")
									.addClass("userName")
            ...
            var myAccountHook = $("<div>").addClass("sub-nav").append($("<a>").attr("id", "signedInUserAccountToggle")
					.addClass("myAccountLinksHeader collapsed js-myAccount-toggle")
					.attr("data-toggle", "collapse")
					.attr("data-target", ".offcanvasGroup2").append($("<span>")
					.text(oMyAccountData.data("title")))
					.append($("<span>").addClass("icon myAcctExp").append($("<i>").addClass("fa fa-angle-down"))));
            ...
            $('#signedInUserAccountToggle').click(function () {
                ...
                if ( $(this).hasClass('show') ) {
                    ...
                    $('#signedInCompanyToggle').find('span i').removeClass('fa-angle-up').addClass('fa-angle-down');
                    $('.offcanvasGroup3').slideUp(400);
                }
                else {
                    $(this).find('span i').removeClass('fa-angle-up').addClass('fa-angle-down');
                }
            });
