ACC.cart = {
    ...
    bindHelp: function () {
        $(document).on("click", ".js-cart-help", function (e) {
            ...
            $("#cboxLoadedContent").parents("#colorbox").css({"height":"250px"});
            $("#cboxLoadedContent").parents("#cboxWrapper").css({"height":"200px"});
            $("#cboxLoadedContent").parents("#cboxContent").css({"height":"200px"});
            $("#cboxLoadedContent").css({"position":"absolute","top":"70px","width":"280px","left":"10px","height":"150px"})
        })
    },
