ACC.address = {
	...
	handleEditAddressClick : function() {
		...
		var options = {
			...
			error : function(xht, textStatus, ex) {
				console.log("Failed to update cart. Error details [" + xht
						+ ", " + textStatus + ", " + ex + "]"); // NOSONAR
			}
		};
	...
	handleDefaultAddressClick : function() {
		...
		var options = {
			...
			error : function(xht, textStatus, ex) {
				console.log("Failed to update address book. Error details ["
						+ xht + ", " + textStatus + ", " + ex + "]"); // NOSONAR
			}
		};
				...
				.each(
						function() {
							var options = {
								...
								error : function(xht, textStatus, ex) {
									console
											.log("Failed to update cart. Error details ["
													+ xht
													+ ", "
													+ textStatus
													+ ", " + ex + "]"); // NOSONAR
	...
	displayCountrySpecificAddressForm : function(options, callback) {
		$.ajax({
			...
			$(".add-address-btn").css("display","flex");
	...
	showRemoveAddressFromBookConfirmation : function() {
		$(document).on(
				...
				function() {
					...
					$("#popup_confirm_address_removal_" + addressId).css(
							"display", "flex");
					$("#popup_confirm_address_removal_" + addressId).find(
							".hide-remove-address-popup").click(
							function(e) {
								$(this).parents(
										"#popup_confirm_address_removal_"
												+ addressId).css("display",
										"none");
							});
				})
	},
