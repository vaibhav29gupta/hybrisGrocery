...
public class SearchPageController extends AbstractGrocerySearchPageController
{
	...
	public String getResultsDisplay(@RequestParam("q")
	...
	final String searchText, @RequestParam(value = "listView", defaultValue = "false")
	final Boolean listView, final HttpServletRequest request, final Model model) throws CMSItemNotFoundException
	{
		getSearchResults(searchQuery, page, showMode, sortCode, searchText, request, model);
		model.addAttribute("listView", listView);
		return ControllerConstants.Views.Fragments.Category.ProductListingFragmentForSearchPage;
	}
	...
	@RequestMapping(value = "/offers/" , method = RequestMethod.GET, params = "q")
	public String offersSearch(@RequestParam("q")
	final String searchQuery, @RequestParam(value = "page", defaultValue = "0")
	final int page, @RequestParam(value = "show", defaultValue = "Page")
	final ShowMode showMode, @RequestParam(value = "sort", required = false)
	final String sortCode, @RequestParam(value = "text", required = false)
	final String searchText, final HttpServletRequest request, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute(WebConstants.BREADCRUMBS_KEY,
				resourceBreadcrumbBuilder.getBreadcrumbs("breadcrumb.offers.page"));
		model.addAttribute("pageType", PageType.PRODUCTSEARCH.name());
		model.addAttribute("offersPage", true);
