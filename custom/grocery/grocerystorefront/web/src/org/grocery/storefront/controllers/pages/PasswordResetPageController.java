...
public class PasswordResetPageController extends AbstractGroceryPageController
{
	...
	//	@Autowired
	//	private GroceryPublishEventFacade groceryPublishEventFacade;
	...
	final ForgottenPwdForm form, final BindingResult bindingResult, final Model model) throws CMSItemNotFoundException
	{
	...
	public String externalPasswordRequest(@Valid
	final ForgottenPwdForm form, final BindingResult bindingResult, final Model model, final RedirectAttributes redirectModel)
			...
			throws CMSItemNotFoundException
	{
		...
		if (!StringUtils.isBlank(form.getToken()))
		{
			try
			{
				...
				//groceryPublishEventFacade.publishUpdatePasswordEvent(form.getToken());
			}
