...
import org.grocery.storefront.controllers.AbstractGroceryCategoryPageController;
...
public class CategoryPageController extends AbstractGroceryCategoryPageController
{
	...
	public String getResultsDisplay(@PathVariable("categoryCode")
	final String categoryCode, @RequestParam(value = "q", required = false)
	final String searchQuery, @RequestParam(value = "page", defaultValue = "0")
	final int page, @RequestParam(value = "show", defaultValue = "Page")
	final ShowMode showMode, @RequestParam(value = "sort", required = false)
	final String sortCode, @RequestParam(value = "listView", defaultValue = "false")
	final Boolean listView, final Model model, final HttpServletRequest request, final HttpServletResponse response)
			throws UnsupportedEncodingException
	{
