...
public class AnonymousConsentController extends AbstractGroceryPageController
{
	...
	final String consentState, final HttpServletRequest request, final HttpServletResponse response)
	{
		...
		{
			LOGGER.error("Exception occured while reading the Anonymous Consent Cookie", e);
			return new ResponseEntity(HttpStatus.BAD_REQUEST);
		}
