...
public class PickupLocationCheckoutStepController extends AbstractGroceryCheckoutStepController
{
	...
	public String enterStep(final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException,NumberFormatException
	{
		...
		{
			final ServiceabilityAreaData serviceabilityAreaData = shipmentFacade.getServiceabilityAreaForPostalCode(Long.parseLong(postalCode));

			if (serviceabilityAreaData != null)
			{
				model.addAttribute("serviceabilityAreaData", serviceabilityAreaData);
	...
	final String posName, final Model model, final RedirectAttributes redirectAttributes)
