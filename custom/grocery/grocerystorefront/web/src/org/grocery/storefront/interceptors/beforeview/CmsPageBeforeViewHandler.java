 ...
 */
package org.grocery.storefront.interceptors.beforeview;
...
import org.grocery.storefront.filters.cms.CMSSiteFilter;
...
public class CmsPageBeforeViewHandler implements BeforeViewHandler
{
	...
	@Autowired
	private GroceryManualCacheRegion jspFragmentCacheRegion;
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		modelAndView.addObject("fragmentCacheEnabled",
            Boolean.valueOf(configurationService.getConfiguration().getBoolean("storefront.jspfragment.cache.enabled", false)));
      modelAndView.addObject("jspFragmentCacheRegion", jspFragmentCacheRegion);
		modelAndView.addObject("spruce-site", cmsSiteService.getCurrentSite().getUid());
	...
	protected AbstractPageModel updateCmsPageInModelAndView(final HttpServletRequest request, final ModelAndView modelAndView)
	{
		...
		final AbstractPageModel requestedPage = (AbstractPageModel) modelAndView.getModel()
				.get(AbstractGroceryPageController.CMS_PAGE_MODEL);
		if (requestedPage != null)
		{
			...
			if (previewPage != null && !previewPage.equals(requestedPage))
			{
				...
				else
				{
					...
					modelAndView.addObject(AbstractGroceryPageController.CMS_PAGE_MODEL, previewPage);
	...
	protected String getViewForPage(final AbstractPageModel page)
	{
		if (page != null)
		{
			...
			if (masterTemplate != null)
			{
				...
				{
					return AbstractGroceryPageController.PAGE_ROOT + targetPage;
				}
			}
		}
		return null;
