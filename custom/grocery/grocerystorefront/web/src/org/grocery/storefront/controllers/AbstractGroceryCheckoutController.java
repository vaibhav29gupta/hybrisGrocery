 ...
 */
public abstract class AbstractGroceryCheckoutController extends AbstractGroceryPageController
{
	protected static final String REDIRECT_URL_ORDER_CONFIRMATION = REDIRECT_PREFIX + "/checkout/orderConfirmation/";

	private static final Logger LOGGER = Logger.getLogger(AbstractGroceryCheckoutController.class);
