...
import org.grocery.storefront.util.UiThemeUtils;
...
public class EmailPageController extends AbstractGroceryPageController
{
	...
	public String get(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView,
			@PathVariable
			final String emailCmsPageUid) throws CMSItemNotFoundException
	{
