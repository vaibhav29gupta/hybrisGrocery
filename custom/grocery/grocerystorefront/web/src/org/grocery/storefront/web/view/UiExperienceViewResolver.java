 ...
 */
package org.grocery.storefront.web.view;
...
public class UiExperienceViewResolver extends InternalResourceViewResolver
{
	...
	public String getViewName(final UiExperienceLevel uiExperienceLevel, final String viewName)
	{
		...
		if (prefix != null)
		{
			if (viewName.startsWith(AbstractGroceryPageController.PAGE_ROOT + ADDON))
			{
				properViewName = viewName.replace(AbstractGroceryPageController.PAGE_ROOT + ADDON, ADDON); // ...pages/addon:/<extension-name>/.../<component-view>....->....addon:/<extension-name>/.../<component-view>
			}
