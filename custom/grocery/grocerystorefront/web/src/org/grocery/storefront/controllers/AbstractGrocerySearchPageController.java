...
/**
 */
public abstract class AbstractGrocerySearchPageController extends AbstractGroceryPageController
{
	...
	private static final Logger LOG = Logger.getLogger(AbstractGrocerySearchPageController.class);
	...
	public void populateModel(final Model model, final SearchPageData<?> searchPageData, final ShowMode showMode)
	{
