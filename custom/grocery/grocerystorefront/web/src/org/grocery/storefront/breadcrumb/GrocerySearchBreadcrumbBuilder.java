 ...
 *
 */
public class GrocerySearchBreadcrumbBuilder
{


	private static final Logger LOG = Logger.getLogger(GrocerySearchBreadcrumbBuilder.class);
			...
			final List<Breadcrumb> breadcrumbs)
	{
		...
		while (!categoryModels.isEmpty())
		{
			...
			{
				if (categoryModel != null && !categoryModel.isIsRootCategory())
				{
