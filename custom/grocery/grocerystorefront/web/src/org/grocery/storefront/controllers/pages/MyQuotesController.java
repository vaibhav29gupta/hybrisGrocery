...
public class MyQuotesController extends AbstractGrocerySearchPageController
{
	...
	@RequireHardLogIn
	public String quote(final Model model, final RedirectAttributes redirectModel, @PathVariable("quoteCode")
	...
	@RequireHardLogIn
	public String getProductVariantMatrixForResponsive(@PathVariable("quoteCode")
	final String quoteCode, @RequestParam("productCode")
