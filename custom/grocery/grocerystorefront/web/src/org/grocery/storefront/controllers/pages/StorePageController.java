...
public class StorePageController extends AbstractGroceryPageController
{
	...
	final String storeCode, @RequestParam(value = "lat", required = false)
	final Double sourceLatitude, @RequestParam(value = "long", required = false)
	final Double sourceLongitude, @RequestParam(value = "q", required = false)
	final String locationQuery, final Model model, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
	...
	final Double sourceLatitude, @RequestParam(value = "long", required = false)
	final Double sourceLongitude, @RequestParam(value = "q", required = false)
	final String locationQuery, final Model model, final PointOfServiceData pointOfServiceData) throws UnsupportedEncodingException
	{
		if (locationQuery != null && !locationQuery.isEmpty())
		{
			...
			final String storeFinderSearchUrl = UriComponentsBuilder.fromPath("/store-finder").queryParam("q", locationQuery).build()
					.toString();
	...
	public String viewMap(@PathVariable("storeCode")
	final String storeCode, final Model model, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		final StoreFinderForm storeFinderForm = new StoreFinderForm();
		model.addAttribute("storeFinderForm", storeFinderForm);
		final StorePositionForm storePositionForm = new StorePositionForm();
