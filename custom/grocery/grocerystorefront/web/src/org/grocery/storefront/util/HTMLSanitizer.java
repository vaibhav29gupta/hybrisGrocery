 ...
 *
 */
package org.grocery.storefront.util;
...
{
	protected static final PolicyFactory POLICY = new HtmlPolicyBuilder().allowElements("pre", "address", "em", "hr", "a")
			.allowAttributes("class").onElements("em", "a").toFactory().and(Sanitizers.BLOCKS).and(Sanitizers.FORMATTING)
