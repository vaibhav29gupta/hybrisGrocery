...
public class GuestOrderController extends AbstractGroceryPageController
{
	...
	public String order(@PathVariable("orderGUID")
	final String orderGUID, final Model model, final HttpServletResponse response) throws CMSItemNotFoundException
	{
		try
		{
